...
clear all; clc;
% Load the XDF file
xdf_file_path = 'test1.xdf';% Add XDF toolbox to path
...
aurora_data = load("2024-06-13_001.nirs", "-mat");
...
aux_data_reshape = zeros(fnirs_len,4,3); % time pts, device (accel 1, accel 2, gyro, magn), metric (x,y,z)
